...
export const mockSaved: SavedItem[] = [
  ...
  { id: 's2', title: 'Demo Section 73, Contract Act', type: 'sections', dateSaved: new Date(Date.now() - 86400000).toISOString(), description: 'Compensation for loss or damage caused by breach of contract.' },
  { id: 's3', title: 'Demo Case A (Sharma & Co. v. Tech Solutions Pvt Ltd)', type: 'cases', dateSaved: new Date(Date.now() - 2 * 86400000).toISOString(), description: 'Commercial suit regarding interim injunction and arbitration.' },
  { id: 's4', title: 'Demo_Software_License_Agreement.pdf', type: 'documents', dateSaved: new Date(Date.now() - 5 * 86400000).toISOString(), description: 'Uploaded document analyzed for risk areas and compliance.' },
  { id: 's5', title: 'Demo Arbitration Act', type: 'sources', dateSaved: new Date(Date.now() - 15 * 86400000).toISOString(), description: 'Primary statute governing domestic and international arbitration.' }
];
