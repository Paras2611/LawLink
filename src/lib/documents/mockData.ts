...
export const mockDocument: Document = {
  id: 'doc-123',
  filename: 'Software_License_Agreement_2026.pdf',
  ...
  analysis: {
    ...
    parties: [
      { name: 'TechSolutions India Pvt Ltd', role: 'Licensor' },
      { name: 'Global Retail Enterprises', role: 'Licensee' }
    ],
    dates: [
    ...
    clauses: [
      {
        ...
        content: 'Subject to the terms and conditions of this Agreement, Licensor grants Licensee a non-exclusive, non-transferable license to use the Software solely for internal business operations.',
        page: 2
      },
      {
        id: 'c2',
        title: 'Limitation of Liability',
        content: 'In no event shall Licensor be liable for any indirect, incidental, special, or consequential damages, including loss of profits or data, arising out of or related to this Agreement.',
        page: 5
      },
      {
        id: 'c3',
    ...
    relatedLaws: [
      {
        ...
        type: 'act',
        relevance: 'Governs the general principles of contract formation, breach, and damages.',
      },
      {
        id: 'law-2',
        title: 'Section 73, Indian Contract Act',
        type: 'section',
        relevance: 'Relevant to the limitation of liability and calculation of damages in case of breach.',
      }
    ],
    aiFindings: [
      'The agreement strongly favors the Licensor regarding liability and termination rights.',
      'No explicit indemnification clause for intellectual property infringement is present.',
      'Data privacy and security obligations are vaguely defined and may not comply with the Digital Personal Data Protection Act.'
    ]
  }
};
